...
const placements: Placement[] = [
  ...
  { kind: "well", x: 0, z: 4 },
  { kind: "stall", x: 11, z: 3 },
  { kind: "stall", x: -7.5, z: 0 },
  { kind: "stall", x: 7.5, z: -18, rotY: Math.PI / 2 },
  { kind: "stall", x: -8, z: -12, rotY: Math.PI },

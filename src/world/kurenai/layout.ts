...
const placements: Placement[] = [
  ...
  { kind: "gardenWall", x: -85.65, z: 50, params: { length: 13.9 } },
  { kind: "gardenWall", x: -99.3, z: 50, params: { length: 13.4 } },
  { kind: "gardenWall", x: -62.1, z: 50, params: { length: 14.4 } },
  { kind: "gardenWall", x: -47.95, z: 50, params: { length: 13.9 } },
  { kind: "gardenWall", x: -106, z: 62.8, rotY: Math.PI / 2, params: { length: 26.4 } },
  { kind: "gardenWall", x: -106, z: 95.2, rotY: Math.PI / 2, params: { length: 26.4 } },
  { kind: "gardenWall", x: -41, z: 62.8, rotY: Math.PI / 2, params: { length: 26.4 } },
  { kind: "gardenWall", x: -41, z: 95.2, rotY: Math.PI / 2, params: { length: 26.4 } },
  ...
  { kind: "machiya", x: -26.8, z: -41.65, params: { width: 6.4, depth: 12.1 } },
  { kind: "machiya", x: 20.37, z: -42.2, params: { width: 6.4, depth: 11, enterable: true, litWindows: true } },
  { kind: "machiya", x: -24.4, z: -61.7, rotY: Math.PI, params: { width: 7.2, depth: 10.8, litWindows: true } },
  { kind: "machiya", x: -16.95, z: -61.8, rotY: Math.PI, params: { width: 6.6, depth: 11 } },
  { kind: "machiya", x: -9.23, z: -62.25, rotY: Math.PI, params: { width: 7.4, depth: 11.9, enterable: true, litWindows: true } },
  { kind: "machiya", x: 6.68, z: -62.65, rotY: Math.PI, params: { width: 7, depth: 12.7, litWindows: true } },
  { kind: "machiya", x: 13.61, z: -61.5, rotY: Math.PI, params: { width: 6.1, depth: 10.4, tint: "#8f7552" } },
  { kind: "machiya", x: 20.59, z: -61.95, rotY: Math.PI, params: { width: 6.4, depth: 11.3, litWindows: true, tint: "#8f7552" } },
  { kind: "kura", x: -9.2, z: -23, rotY: Math.PI },
  { kind: "kura", x: -24.8, z: 8.2, rotY: -Math.PI / 2 },
  { kind: "kura", x: -39.1, z: -34.2, rotY: -Math.PI / 2 },
  ...
  { kind: "cart", x: 7, z: -89 },
  // ===== the hamlets ===============================================================
  { kind: "minka", x: -104.8, z: 14.9, params: { width: 10.4, depth: 7.8 } },
  { kind: "kura", x: -89.5, z: 12.6 },
  { kind: "kura", x: -86.5, z: 40.2, rotY: Math.PI },
  { kind: "minka", x: 87.9, z: 13.9, params: { width: 11.1, depth: 7.6 } },
  { kind: "kura", x: 103.4, z: 12.4, rotY: Math.PI / 2 },
  { kind: "kura", x: 87.3, z: 25.2, rotY: Math.PI / 2 },
  { kind: "kura", x: 103.2, z: 25.1, rotY: Math.PI / 2 },
  { kind: "minka", x: 87.3, z: 39.5, params: { width: 12.1, depth: 7.8 } },
  { kind: "kura", x: 101.2, z: 40.9 },
  { kind: "kura", x: -55.8, z: -105.3 },
  { kind: "kura", x: -40.6, z: -104.7, rotY: Math.PI / 2 },
  { kind: "woodpile", x: -46.27, z: -110.25, rotY: Math.PI / 2 },
...
const scatter: ScatterSpec[] = [
  ...
  // ===== the woods =================================================================
  { prop: "maple", x: -110.7, z: -111.8, radius: 3.5, count: 1, scale: [1.1, 1.55], blocking: true, clearance: 1.8 },
  { prop: "maple", x: -86.7, z: -110, radius: 3.5, count: 1, scale: [1.1, 1.55], blocking: true, clearance: 1.8 },
  { prop: "maple", x: -66.3, z: -108.7, radius: 6, count: 2, scale: [1.1, 1.55], blocking: true, clearance: 1.8 },
  { prop: "maple", x: -51.7, z: -104.2, radius: 10, count: 5, scale: [1.1, 1.55], blocking: true, clearance: 1.8 },
  { prop: "maple", x: -24.5, z: -108.8, radius: 6, count: 2, scale: [1.1, 1.55], blocking: true, clearance: 1.8 },
  { prop: "maple", x:
radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -76.9, z: -34, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -15.2, z: -33.9, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -5.1, z: -38.3, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 17.2, z: -42.9, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 11.4, z: -24.9, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 35, z: -21.4, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 52.5, z: -18.9, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 85.8, z: -21.6, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -23.1, z: 14.5, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -5.2, z: 20.4, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 53.1, z: 18.4, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 66.5, z: 17.8, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 86.4, z: 14.9, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 108.7, z: 12.3, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -2.3, z: 37.5, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 12.8, z: 34.1, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 2.9, z: 56.6, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 20.2, z: 49.2, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -0.9, z: 70.7, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 12.4, z: 65.9, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -4.8, z: 86.2, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -95.7, z: 101.7, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: -0.1, z: 104.8, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  { prop: "leafLitter", x: 110.2, z: 110.5, radius: 7, count: 8, scale: [0.9, 1.3], clearance: 0.6 },
  ...
  // ===== the riverbanks ============================================================
  { prop: "boulder", x: -114, z: -15, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: -98, z: -4.7, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: -50, z: -5.3, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: -34, z: -14, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: 30, z: -4.3, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: 46, z: -4.5, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: 94, z: -11.5, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  { prop: "boulder", x: 110, z: -13.3, radius: 3, count: 2, scale: [0.5, 0.9], blocking: true, clearance: 1.0 },
  ...
  { prop: "boulder", x: 35.3, z: 96.6, radius: 1.2, count: 1, scale: [0.45, 0.75], blocking: true, clearance: 0.4 },
  { prop: "boulder", x: 34.1, z: 88.9, radius: 1.2, count: 1, scale: [0.45, 0.75], blocking: true, clearance: 0.4 },
  { prop: "boulder", x: 40, z: 84.4, radius: 1.2, count: 1, scale: [0.45, 0.75], blocking: true, clearance: 0.4 },
  ...
  // ===== the borderland ============================================================
  { prop: "maple", x: -160, z: 176.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -160, z: -173.6, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 136.7, z: -160, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -150.7, z: -160, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -135.4, z: 170.8, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -135.4, z: -147.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 137.3, z: -135.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -139.5, z: -135.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -110.8, z: 169.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -110.8, z: -146, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 144.1, z: -110.8, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -163.4, z: -110.8, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -86.2, z: 144.6, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -86.2, z: -156.3, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 145, z: -86.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -136.7, z: -86.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -61.5, z: 138.3, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -61.5, z: -148.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 157.5, z: -61.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -135, z: -61.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -36.9, z: 166.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -36.9, z: -178, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 152.6, z: -36.9, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -138.8, z: -36.9, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -12.3, z: 137.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -12.3, z: -168, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 12.3, z: 176.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 12.3, z: -177.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 148.8, z: 12.3, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -133.5, z: 12.3, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 36.9, z: 134, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 36.9, z: -152.8, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 163.5, z: 36.9, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -159.7, z: 36.9, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 61.5, z: 149, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 61.5, z: -138.9, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 146.9, z: 61.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -143.3, z: 61.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 86.2, z: 164.1, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 86.2, z: -155.3, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 158.6, z: 86.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -138, z: 86.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 110.8, z: 133.6, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 110.8, z: -166.2, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 147.8, z: 110.8, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -174, z: 110.8, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 135.4, z: 161.6, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 135.4, z: -135.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 166.6, z: 135.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -153.2, z: 135.4, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 160, z: 179.5, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 160, z: -165, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: 154, z: 160, radius: 12, count: 5, scale: [0.9, 1.3] },
  { prop: "maple", x: -133.9, z: 160, radius: 12, count: 5, scale: [0.9, 1.3] },
];
...
const water: WaterRect[] = [
  ...
  { x: -52.38, z: 94, width: 24.75, depth: 19.5, y: 2.7 },
  // The inn's hot spring, dug into its garden.
  { x: 44.13, z: 92.38, width: 24.75, depth: 20.25, y: 0.7 },
];
